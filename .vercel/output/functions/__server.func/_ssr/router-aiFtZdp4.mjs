...
//#region node_modules/.nitro/vite/services/ssr/assets/router-aiFtZdp4.js
var router_aiFtZdp4_exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-BnvF39Kx.css";
var APP_NAME = "Maestro Console";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Interactive studio console for Maestro v1.8.7.1 — models, every control, and hardware-aware settings."
			},
			{
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;0,700;1,500&family=IBM+Plex+Mono:wght@400;500&family=IBM+Plex+Sans:wght@400;500;600&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$1 = () => import("./routes-BhRv4-9j.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-Dr0I1pH5.mjs");
...
//#endregion
export { router_aiFtZdp4_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
