...
import { i as getBaseURL, r as PACKAGE_VERSION, t as GENERIC_OAUTH_ERROR_CODES } from "./router-aiFtZdp4.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/button-DsLW8940.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 rounded-sm font-sans text-sm font-medium tracking-wide transition-colors duration-150 disabled:pointer-events-none disabled:opacity-40", {
	variants: {
		variant: {
			primary: "bg-gold text-bg hover:bg-gold-bright",
			secondary: "border border-gold/35 bg-transparent text-gold hover:bg-gold/10",
