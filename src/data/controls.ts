...
export const CONTROLS: StudioControl[] = [
  ...
  },
  {
    ...
    group: "prompt",
    families: "*",
    what: "The instruction. For H3, write like a director: who speaks, what the camera does, when it is silent. For Wan / Hunyuan, write like a shot description. For Music3, use official bare section tags and lyrics — stage directions get sung. v1.9.0: the editor grows with the text and browser spellcheck is on.",
  ...
  },
  {
    ...
    group: "prompt",
    families: H3,
    what: "Local preprocessing that turns free-form multimodal notes into a Context Intermediate Representation: speaker IDs, dialogue, silence, and how refs relate to the shot. v1.9.0 keeps requested dialogue languages and visual details from attached frames. H3 quality depends on this more than on purple prose.",
  ...
  },
  {
    ...
    group: "lora",
    families: "*",
    what: "Side adapters from the built-in CivitAI browser. v1.9.0 moved LoRA selection to the top of Advanced. AI prompt guides and recommended weights are applied when the LoRA is selected. Multi-LoRA packs unpack automatically. H3 is less LoRA-centric than LTX-2.3 / Wan.",
    ...
    leaveAlone: "If two character LoRAs fight, delete one. Do not average them at 0.9 each. v1.9.0: LoRAs live at the top of Advanced.",
    badges: ["pro"],
    kind: "lora",
  },
  {
    ...
    group: "queue",
    families: "*",
    what: "v1.9.0: one global Studio + Director queue. The live app is a top-bar popover with a count badge. Generate starts now. Add to Queue holds the complete job without touching the GPU. Start, pause, reorder, remove. Unfinished jobs do not appear as blank gallery cards. Director projects in the queue own copies of their inputs and survive restarts.",
